...
bigimg:
  [
    {
      src: "https://picdn.youdianzhishi.com/images/photo-1563713665854-e72327bf780e.jpeg",
...
![kubernetes kubectl](https://picdn.youdianzhishi.com/images/kubernetes-kubectl.svg)
...
![kubectl 自动补全](https://picdn.youdianzhishi.com/images/kubectl-cmd-complete.gif)
...
![kubectl explain command action](https://picdn.youdianzhishi.com/images/kubectl-explain-action.svg)
...
![kubeconfig file content](https://picdn.youdianzhishi.com/images/kubectl-kubeconfig-content.svg)

从上图我们可以看出 kubeconfig 文件由一组 Context（上下文）组成，一个 Context 包含以下 3 个元素：
...
![kubectl kubeconfig current context](https://picdn.youdianzhishi.com/images/kubectl-kubeconfig-current-context.svg)
...
![kubectl kubeconfig change current context](https://picdn.youdianzhishi.com/images/kubectl-kubeconfig-change-current-context.svg)

比如上图中，kubectl 现在会连接到 Fox 集群了。

如果要切换到同一个集群中的另外一个命名空间，那么我们可以更改当前上下文中的命名空间属性的值：

![kubectl kubeconfig change namespace](https://picdn.youdianzhishi.com/images/kubectl-kubeconfig-change-namespace.svg)
...
![kubectl kubectx action](https://picdn.youdianzhishi.com/images/kubectl-kubectx-action.gif)
...
![kubectl shell alias](https://picdn.youdianzhishi.com/images/kubectl-shell-alias.gif)
...
![kubectl plugin action](https://picdn.youdianzhishi.com/images/kubectl-plugin-action.gif)
...
从[1.12 版本](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG-1.12.md#sig-cli-1)开始，kubectl 就提供了一个[插件机制](https://kubernetes.io/docs/tasks/extend-kubectl/kubectl-plugins/)，允许我们通过自定义命令来扩展 kubectl。

下面是一个插件示例，可以通过调用`kubectl hello`来打印一句话：
![kubectl plugin hello](https://picdn.youdianzhishi.com/images/kubectl-plugin-hello.svg)
...
![krew in action](https://picdn.youdianzhishi.com/images/kubectl-krew-demo.svg)
