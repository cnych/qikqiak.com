...
gitcomment: true
notoc: true
bigimg: [{ src: "https://picdn.youdianzhishi.com/images/xb4u8.jpg", desc: "" }]
category: "kubernetes"
---

[![Prometheus Operator 高级配置](https://picdn.youdianzhishi.com/images/goc2kc.jpg)](https://mp.weixin.qq.com/s/M47g8E3BHzb6IhLiI1P5oA)
...
如果你对上面这个配置还不是很熟悉的话，建议去查看下前面关于 [Kubernetes 常用资源对象监控章节的介绍](https://)，要想自动发现集群中的 Service，就需要我们在 Service 的`annotation`区域添加`prometheus.io/scrape=true`的声明，将上面文件直接保存为 prometheus-additional.yaml，然后通过这个文件创建一个对应的 Secret 对象：
...
![config](https://picdn.youdianzhishi.com/images/dA0ZT5.jpg)
...
![endpoints](https://picdn.youdianzhishi.com/images/UioYnQ.jpg)
