...
![Kui](https://bxdc-static.oss-cn-beijing.aliyuncs.com/images/20200312170004.png)

默认情况下 Kui 下面可以使用命令 `k` 来代替 `kubectl`，往往平时我们使用的时候也会为 `kubectl` 添加一个别名，提高操作效率。

![command k](https://bxdc-static.oss-cn-beijing.aliyuncs.com/images/20200312170300.png)

通过命令获取的 K8S 资源对象同样我们可以通过点击在右侧展示对象的详细信息：

![object detail](https://bxdc-static.oss-cn-beijing.aliyuncs.com/images/20200312170637.png)
